...
import 'package:nexus_aura/pages/chat_page.dart';
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        hintStyle: TextStyle(
                            color: AppColors.boldColor, fontSize: 18)),
                  ),
                ),
                GestureDetector(
                  onTap: () {
        ...
        onTap: () async {
          ...
          if (isJoined) {
            ...
            showSnackbar(context, AppColors.boldColor,
                "Successfully joined the new Nexus");
            ...
            setState(() {
              isJoined = !isJoined;
              showSnackbar(context, Colors.red, "Left the Nexus $groupName");
            });
          }
        },
        child: isJoined
